...
The actual labels from Census are a bit awkward (e.g.
"Estimate!!Total!!Worked at home"), so replace them with something simpler.
Note that the Label 'Worked from Home' had a different 'Name' in 2005 as opposed
to every other year.
"""
